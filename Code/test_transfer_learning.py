...
def create_manual_model():
    ...
    my_new_manual_model = Sequential()
    #最後一層拔掉的model
    my_new_manual_model.add(final_Model)
    #最後一層再加上一層sofmax的層
    my_new_manual_model.add(Dense(num_classes, activation='softmax'))
    """
...
def main():
    ...
    my_new_manual_model = create_manual_model()
    ##print("----------")
    ...
    train_mondel(my_new_manual_model)
